                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <h3 className="mt-3">brand: <span >{getuserdata.brand}</span></h3>
                            <p className="mt-3"><ModelTrainingIcon />model: <span>{getuserdata.model}</span></p>
                
                        </div>
                        <div className="right_view  col-lg-6 col-md-6 col-12">

                            <p className="mt-5"><ProductionQuantityLimitsIcon />quantity: <span>+91 {getuserdata.quantity}</span></p>
                            <p className="mt-3"><PriceChangeIcon />price: <span>{getuserdata.price}</span></p>
